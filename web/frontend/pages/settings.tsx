...
function PrintTemplateGroup({
  ...
  const availableVariables = {
    workOrderPrintTemplates: {
      ...
      '{{ items[x].purchaseOrderName }}': 'The name of the purchase order that the item is in at index x',
      ...
      '{{ items[x].charges[y].paid }}': 'Whether the charge at index y of the item at index x has been paid for',
      ...
      '{{ charges[x].paid }}': 'Whether the charge at index x has been paid for',
    },
